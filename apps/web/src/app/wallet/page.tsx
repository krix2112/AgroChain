...
export default function WalletPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex">
      ...
      <main className="flex-1 lg:ml-72 p-12 flex items-center justify-center">
          ...
          <div className="relative">
            ...
            <div className="space-y-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button className="py-5 bg-white text-black font-black rounded-3xl hover:bg-emerald-400 hover:scale-[1.02] transition-all">
                  Refresh Balance
                </button>
                <button className="py-5 bg-white/5 text-white font-black rounded-3xl border border-white/5 hover:bg-white/10 transition-all">
                  Export Keys
                </button>
              </div>
            </div>
