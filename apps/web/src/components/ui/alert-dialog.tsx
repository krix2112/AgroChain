...
// Note: button.tsx is missing, so I'm using temporary class placeholders for now.
// Once user provides button.tsx, we should use buttonVariants().
const buttonVariantsPlaceholder = ({ variant = "default" } = {}) => {
...
function AlertDialogAction({
  ...
  return (
    <AlertDialogPrimitive.Action
      className={cn(buttonVariantsPlaceholder(), className)}
      {...props}
    />
  );
}
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Cancel
      className={cn(buttonVariantsPlaceholder({ variant: "outline" }), className)}
      {...props}
    />
  );
}
